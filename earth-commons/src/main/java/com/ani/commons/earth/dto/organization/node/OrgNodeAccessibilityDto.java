 ...
 */
public class OrgNodeAccessibilityDto extends AccessibilityDto {

    private static final long serialVersionUID = -3327642775366338199L;

    private Long resourceNodeId;

    public OrgNodeAccessibilityDto(Long requestAccountId, PrivilegeType privilegeType, Long resourceNodeId) {
