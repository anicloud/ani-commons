...
//    public void sendVerificationCode(String sessionId,String register) throws AniRuleException;
    /**
     ...
     */
    public Long accountRegister(String sessionId,AccountRegisterDto accountRegisterDto) throws AniRuleException;

    /**
     * <h2>Register account without basic info</h2>
     *
     * @param accountProfileDto no property required
     * @return AniAccount
     * @throws AniRuleException
     */
    public AniAccount accountRegister(AccountProfileDto accountProfileDto) throws AniRuleException;
